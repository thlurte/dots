...
DraggableDesktopWidget {
  ...
  Process {
    id: proc
    command: ["python3", "/home/ahmed/.config/noctalia/plugins/twitter-feeds/fetch.py"]
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      NIconButton {
        ...
        tooltipText: root.expanded ? "Collapse" : "Show all tweets"
    ...
    NText {
      visible: root.expanded
      text: "Click a tweet to open on x.com · click X to collapse"
      color: Color.mOnSurfaceVariant
      pointSize: Style.fontSizeXS * widgetScale
      Layout.fillWidth: true
    }
    ...
    NText {
      ...
      text: root.errors.length ? root.errors[0] : "No tweets — add handles in settings"
